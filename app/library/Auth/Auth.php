...
class Auth extends Component
{
    ...
    public function check($credentials)
    {
        ...
        if ($user == false) {
            ...
            throw new Exception('Falsche Email/Passwort Kombination');
        }
    ...
    {
        if ($user->active != 'Y') {
            throw new Exception('Dieser Benutzer ist noch nicht aktiviert');
        }

        if ($user->banned != 'N') {
            throw new Exception('Dieser Benutzer ist gebannt');
        }

        if ($user->suspended != 'N') {
            throw new Exception('Dieser Benutzer ist gesperrt');
        }
    }
